...
if __name__ == '__main__':
    ...
    #             model_paths=None, best_dir='./logs/best_model_stage1/',
    #             save_name='ppo_dir_stage1', results_dir='./logs/results_stage1/')

    # # ---- Stage 2: 横滚(副翼) ----
    # train_stage(stage=2, total_timesteps=1_200_000, n_envs=n_envs, seed=SEED,
    #             model_paths={'dir': 'ppo_dir_stage1'}, best_dir='./logs/best_model_stage2/',
    #             save_name='ppo_lat_stage2', results_dir='./logs/results_stage2/')

    # # ---- Stage 3: 俯仰(升降副翼) ----
    train_stage(stage=3, total_timesteps=1_400_000, n_envs=n_envs, seed=SEED,
                model_paths={'dir': 'ppo_dir_stage1', 'lat': 'ppo_lat_stage2'},
                best_dir='./logs/best_model_stage3/',
                save_name='ppo_lon_stage3', results_dir='./logs/results_stage3/')
